...
function checkLang(str){
    ...
    PHONENUMBER_EMPTY = "Please choose at least one Phone Number:";
...
function validate() {
  if((isEmpty(HOME_PHONE_FIELD_NAME))&&(isEmpty(WORK_PHONE_FIELD_NAME))){
  //alert(isEmpty(HOME_PHONE_FIELD_NAME));
  //alert(isEmpty(WORK_PHONE_FIELD_NAME));
    handleErrorDiv(PHONENUMBER_EMPTY);
    return false;
  }
